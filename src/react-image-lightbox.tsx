...
type LightboxProps = typeof ReactImageLightbox.defaultProps & {
  ...
  onMovePrevRequest?: (
    event?: React.MouseEvent | React.WheelEvent | React.KeyboardEvent
  ) => void;
...
class ReactImageLightbox extends Component<LightboxProps> {
  static isTargetMatchImage(target: HTMLElement | null) {
  ...
  // Used to pinch
  pinchTouchList: Pick<Pointer, 'id' | 'x' | 'y'>[] | null = null;
  pinchDistance = 0;
  ...
  isImageLoaded(imageSrc: string | undefined): imageSrc is string {
    return (
      !!imageSrc &&
