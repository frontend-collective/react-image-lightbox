...
var ReactImageLightbox = /*#__PURE__*/function (_Component) {
  ...
  function ReactImageLightbox(props) {
    ...
    _this.requestMoveTo = _this.requestMoveTo.bind(_assertThisInitialized(_this));
    return _this;
  ...
  _createClass(ReactImageLightbox, [{
    ...
    value: function getFitSizes(width, height, stretch) {
      ...
      var imageVerticalPadding = this.props.imagePadding < 128 ? 129 : this.props.imagePadding;
      imageVerticalPadding = boxSize.width > 600 ? 170 : imageVerticalPadding;
      var widthImagePadding = boxSize.width < 600 ? 15 : this.props.imagePadding;
    ...
    value: function render() {
      ...
      var renderIndicators = function renderIndicators() {
        ...
        var _loop = function _loop(i) {
          indicators.push( /*#__PURE__*/React__default.createElement("li", {
            key: i,
      ...
      var addImage = function addImage(srcType, imageClass, transforms) {
        ...
        var getTopMarginForNavigationButtons = function getTopMarginForNavigationButtons(imageHeight) {
        ...
        if (bestImageInfo && srcType === 'mainSrc') {
          imageMargin = Math.floor(getButtonMarginSize(bestImageInfo.targetWidth));
          var imageTop = getTop(bestImageInfo.targetHeight);
          var marginForNavigationButtons = getTopMarginForNavigationButtons(bestImageInfo.targetHeight);
          headerStyle.top = getHeaderMargin(bestImageInfo.targetHeight) - imageTop;
          ...
          var textStartsAt = gettopBlankSpace(bestImageInfo.targetHeight) - imageTop + bestImageInfo.targetHeight + 10;
          ...
          imageStyle = _objectSpread2(_objectSpread2({}, transitionStyle), ReactImageLightbox.getTransform(_objectSpread2(_objectSpread2({}, newTransforms), bestImageInfo)));
        } else {
          imageStyle = _objectSpread2(_objectSpread2({}, transitionStyle), ReactImageLightbox.getTransform(_objectSpread2(_objectSpread2({}, transforms), bestImageInfo)));
        }
        ...
        if (bestImageInfo === null && hasTrueValue(loadErrorStatus)) {
          images.push( /*#__PURE__*/React__default.createElement("div", {
            className: "".concat(imageClass, " ril__image ril-errored fade-in"),
            style: imageStyle,
        ...
        if (bestImageInfo === null) {
          var loadingIcon = /*#__PURE__*/React__default.createElement("div", {
      ...
      })))), Number.isInteger(this.props.index) && this.props.length && /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("ol", {
        className: "ril__indicators"
      }, renderIndicators())), this.props.imageCaption &&
      /*#__PURE__*/
