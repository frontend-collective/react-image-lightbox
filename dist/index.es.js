    ...
    _createClass(ReactImageLightbox, [
      ...
      return {
        ...
        height: (height * maxWidth) / width,
          ...
          var maxHeight = boxSize.height - (this.props.imagePadding * 2 + 24);
          var maxWidth = boxSize.width - (this.props.imagePadding * 2 + 24);
        ...
        value: function render() {
          ...
          var addImage = function addImage(srcType, imageClass, transforms) {
            ...
            if (bestImageInfo && srcType === 'mainSrc') {
              ...
              headerStyle['backgroundColor'] = 'rgba(0,0,0,.5)'; //headerStyle.margin = '0 auto';
              ...
              descriptionBoxStyle.width = '100%'; // descriptionBoxStyle.margin = '0 auto';
              ...
              imageStyle = _objectSpread2(
                ...
                ReactImageLightbox.getTransform(
                  _objectSpread2({}, newTransforms, {}, bestImageInfo)
                )
              );
            } else {
              imageStyle = _objectSpread2(
